									...
									<div class="card-body card-body--dashboard">
										<div class="row">
											...
											<div class="col-lg-6">
												<ul class="nav nav-pills justify-content-end" role="tablist" id="topEjecutivos-tabs">
												  <!-- <li class="nav-item"><a class="nav-link nav-link--dashboard active" href="#topEjecutivos-uf" data-toggle="tab" aria-controls="#topEjecutivos-uf" aria-selected="true" id="topEjecutivos-uf-tab">UF</a></li> -->
												</ul>
											</div>
										</div>
										<div class="tab-content" id="topEjecutivos-content">
											<div class=" bar-chart3 tab-pane fade show active" role="tabpanel" aria-labelledby="#topEjecutivos-tab" id="topEjecutivos">
												<canvas id="topEjecutivos-chart"></canvas>
											</div>
										</div>
									</div>
								</div>
										...
										<div class="row">
											...
											<div class="col-lg-6">
												<ul class="nav nav-pills justify-content-end" role="tablist" id="topCorredores-tabs">
												 <!--<li class="nav-item"><a class="nav-link nav-link--dashboard active" href="#topCorredores-uf" data-toggle="tab" aria-controls="#topCorredores-uf" aria-selected="true" id="topCorredores-uf-tab">UF</a></li> -->
												</ul>
											</div>
										</div>
										<div class="tab-content" id="topCorredores-content">
											<div class="bar-chart3 tab-pane fade show active" role="tabpanel" aria-labelledby="#topCorredores" id="topCorredores">
